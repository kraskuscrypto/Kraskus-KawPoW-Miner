...
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
	...
	# Kraskus fork: C++ only. With CMake's native CUDA support add_compile_options also reaches
	# nvcc, which treats these MSVC switches as extra input files ("A single input file is
	# required for a non-link phase"); nvcc gets its host flags through -Xcompiler itself.
	add_compile_options("$<$<COMPILE_LANGUAGE:CXX>:/MP;/EHsc;/GL;/wd4068;/wd4267;/wd4290>")
